Do not name your the project 'raylib', it will conflict with the raylib library.

# Compiling

==NOTE==: this was copied from raylib-quickstart. Secondary targets are not tested and may not work.
